...
from write_did_functions import pool_configuration, restart_pool,  print_log, create_wallet, create_did_and_verkey, nym_request, get_nym_request, cleanup
...
async def write_nym_and_query_verkey():
    ...
    try:
        ...
        get_nym_response = await get_nym_request(pool_,steward,trust_anchor)

        # See whether we received the same info that we wrote the ledger in step 4.
        
        print_log('\n Comparing Trust Anchor verkey as written by Steward and as retrieved in GET_NYM '
